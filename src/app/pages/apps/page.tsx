    ...
    <div>
      ...
      <div className="flex justify-center">
        <div className="backdrop-blur-md border shadow-lg rounded-3xl ml-20 mr-20 mb-10 mt-10 p-10 max-w-3xl">
          ...
          <Link className="border rounded-2xl p-2.5 hover:shadow-lg" style={{color: '#6E717A', borderColor: 'rgb(255, 255, 255)'}} href="/pages/apps/220-1101">Start</Link>
        </div>
      </div>
      {/* ----------------------------------------------------------------- */}
      <div className="flex justify-center">
        <div className="backdrop-blur-md border shadow-lg rounded-3xl ml-20 mr-20 mb-20 p-10 max-w-3xl">
          <h1 className="text-3xl">CompTIA Testing (220-1102)</h1>
          ...
          <Link className="border rounded-2xl p-2.5 hover:shadow-lg" style={{color: '#6E717A', borderColor: 'rgb(255, 255, 255)'}} href="/pages/apps/220-1102">Start</Link>
        </div>
      </div>
      {/* ----------------------------------------------------------------- */}
    </div>
