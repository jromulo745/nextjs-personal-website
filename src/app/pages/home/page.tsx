    ...
    <div>
      ...
      <div style={{maxWidth: '768px', margin: '0 auto', padding: '8px 0 0 0'}}>
        <div className="flex mt-5 mb-5" style={{justifyContent: 'around', gap: '15px'}}>
          ...
          <div className="backdrop-blur-md border shadow-lg rounded-xl pl-10 pr-10 pt-5 pb-5 min-w-0 min-h-0 overflow-hidden flex flex-col" style={{alignItems: 'center', flex: '1'}}>
